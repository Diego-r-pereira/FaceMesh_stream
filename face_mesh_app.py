...
if app_mode == 'About App':
    st.markdown('In this Application we are using **MediaPipe** fore creating a FaceMesh App. **StreamLit** is to '
                'create the Web Graphical User Interface (GUI)')
    ...
    st.markdown('''
        ...
        - [YouTube](https://www.youtube.com/user/alejandro76980/featured)
        - [LinkedIn](https://www.linkedin.com/in/diego-alejandro-rojas-pereira-864859201/)
        - [FaceBook](https://www.facebook.com/AlejandroBjornIron/)
        - [Instagram](https://www.instagram.com/diego_a_r_pereira/)
        
        If you are feeling generous you can buy me a **cup of coffee** from [HERE](https://www.instagram.com/p/CfGaMvXswTw/)
